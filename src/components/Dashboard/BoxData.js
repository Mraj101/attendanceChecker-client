...
const BoxData = ({data}) => {
  console.log(data,"inside box data")
  return (
    <>
    <div className="flex gap-10 p-5">
    {/* <div className="h-32 w-40 border border-gray-300 rounded-lg shadow-md">
      ...
      <svg
          ...
          strokeWidth="1.5"
          stroke="currentColor"
          className="w-7 h-7 border border-gray-200 p-1 rounded-lg"
        >
          <path
            strokeLinecap="round"
        ...
        <p className="font-extralight text-xl">Employees</p>
      </div>
    </div> */}
...
<div className="h-36 w-48 border border-gray-300 rounded-lg shadow-md">
      ...
      <div className="text-center text-4xl font-bold">13</div>
    </div>
